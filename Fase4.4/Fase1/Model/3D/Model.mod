...
'@ define farfield monitor: farfield (f=4.8)
...
With Monitor 
     ...
     .UseSubvolume "False" 
     .Coordinates "Structure" 
     .SetSubvolume "-84.5756", "20.409", "-130", "120", "0", "6.615" 
     .SetSubvolumeOffset "10", "10", "10", "10", "10", "10" 
     .SetSubvolumeInflateWithOffset "False" 
     .SetSubvolumeOffsetType "FractionOfWavelength" 
     .EnableNearfieldCalculation "True" 
...
'@ delete monitor: farfield (f=5.2)

'[VERSION]2020.7|29.0.1|20200710[/VERSION]
Monitor.Delete "farfield (f=5.2)"

'@ delete monitor: farfield (f=4.8)

'[VERSION]2020.7|29.0.1|20200710[/VERSION]
Monitor.Delete "farfield (f=4.8)" 
